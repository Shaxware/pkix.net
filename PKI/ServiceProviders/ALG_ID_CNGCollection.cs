...
namespace PKI.ServiceProviders {
	...
	public class ALG_ID_CNGCollection : ICollection {
		...
		/// </summary>
		public ALG_ID_CNGCollection() { m_list = new ArrayList(); }
		...
		public Int32 Add(ALG_ID_CNG entry) { return m_list.Add(entry); }
		/// <summary>
		...
		/// <returns></returns>
		public ALG_ID_CNG this[Int32 index] {
			get { return m_list[index] as ALG_ID_CNG; }
		}
		/// <summary>
		...
		public ALG_ID_CNG this[String name] {
			get {
				foreach (ALG_ID_CNG entry in m_list) {
