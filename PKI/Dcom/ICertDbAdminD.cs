...
namespace SysadminsLV.PKI.Dcom {
    ...
    public interface ICertDbAdminD {
        ...
        AdcsPropCertState ApproveRequest(UInt32 requestID);
        /// <summary>
        /// Denies specified pending certificate request.
        /// </summary>
        /// <param name="requestID">RequestID from Certification Authority database.</param>
        void DenyRequest(UInt32 requestID);
        /// <summary>
        ...
        UInt32 DeleteDatabaseRow(UInt32 requestID, AdcsDbCRTable table = AdcsDbCRTable.Request);
        /// <summary>
        ...
        UInt32 DeleteExpiredRequests(DateTime notAfter);
        /// <summary>
        ...
        /// <returns>Number of removed rows.</returns>
        UInt32 DeleteExpiredCRLs(DateTime notAfter);
        /// <summary>
        ...
        /// <returns>Number of removed rows.</returns>
        UInt32 DeleteLastUpdatedRequests(DateTime notAfter);
        /// <summary>
        ...
        UInt32 ImportCertificate(X509Certificate2 certificate);
        /// <summary>
