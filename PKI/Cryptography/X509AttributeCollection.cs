...
namespace System.Security.Cryptography {
	...
	public class X509AttributeCollection : ICollection {
		...
		public X509AttributeCollection(X509Attribute[] attributes) {
			m_list = new List<X509Attribute>(attributes);
		}
		...
		/// <returns></returns>
		public X509Attribute this[Int32 index] {
			get { return m_list[index] as X509Attribute; }
		}
		/// <summary>
		...
		public X509Attribute this[String oid] {
			get {
				foreach (X509Attribute entry in m_list) {
