...
namespace PKI.CertificateTemplates {
	...
	public enum CertificateTemplateNameFlags {
		...
		/// <summary>
		/// This flag instructs the CA to add the value of the objectGUID attribute from the requestor's user object in Active Directory to the Subject
		/// Alternative Name extension of the issued certificate.
		/// </summary>
		AltSubjectRequireDirectoryGUID		= 0x01000000, // 16777216
		/// <summary>
		/// This flag instructs the CA to add the value of the UPN attribute from the requestor's user object in Active Directory to the Subject Alternative
		/// Name extension of the issued certificate.
		/// </summary>
		AltSubjectRequireUPN				= 0x02000000, // 33554432
		/// <summary>
		/// This flag instructs the CA to add the value of the e-mail attribute from the requestor's user object in Active Directory to the Subject Alternative
		/// Name extension of the issued certificate.
		/// </summary>
		AltSubjectRequireEmail				= 0x04000000, // 67108864
		/// <summary>
		/// This flag instructs the CA to add the value obtained from the DNS attribute of the requestor's user object in Active Directory to the Subject Alternative
		/// Name extension of the issued certificate.
		/// </summary>
		AltSubjectRequireDNS				= 0x08000000, // 134217728
		/// <summary>
		/// This flag instructs the CA to add the value obtained from the DNS attribute of the requestor's user object in Active Directory as the CN in the subject
		/// of the issued certificate.
		/// </summary>
		SubjectRequireDNSasCN				= 0x10000000, // 268435456
		/// <summary>
		/// This flag instructs the CA to add the value of the e-mail attribute from the requestor's user object in Active Directory as the subject of the issued certificate.
		/// </summary>
