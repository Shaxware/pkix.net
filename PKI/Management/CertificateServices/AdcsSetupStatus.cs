...
namespace SysadminsLV.PKI.Management.CertificateServices {
    ...
    public enum AdcsSetupStatus {
        ...
        /// <summary>
        /// Certification Authority installation is incomplete. This value indicates that subordinate CA is
        /// installed and awaits CA certificate installation (in the case with offline parent CA). CA service
        /// will not start until installation is completed.
        /// </summary>
        Incomplete					= 0x00000004, // 4
        /// <summary>
        /// Subordinate CA has requested certificate renewal and awaits new CA certificate installation. CA
        /// can run in normal mode and issue certificates to clients.
        /// </summary>
        ...
        /// <summary>
        /// Permissions changed while the CA was down and the CA will need to update the directory service
        /// when it restarts.
        /// </summary>
