...
namespace SysadminsLV.PKI.Management.CertificateServices {
    /// <summary>
    /// The class represents Active Directory Certification Authority (<strong>CA</strong>) object.
    /// </summary>
    public class AdcsCertificateAuthority {
        ...
        /// </summary>
        public AdcsSetupStatus SetupStatus { get; private set; }
        /// <summary>
        ...
        void getVersion() {
            if (RegistryOnline) {
                ...
                SetupStatus = (AdcsSetupStatus)CryptoRegistry.GetRReg("SetupStatus", String.Empty, ComputerName);
            } else {
                ...
                SetupStatus = AdcsSetupStatus.Unknown;
            }
        }
        void getWmiData() {
            try {
        ...
        internal String GetConfigEntry(String entry) {
            switch (entry) {
                ...
                case "CATruncatedName":
                    return ActiveDirectory.GetSanitizedName(Name);
                case "ConfigurationContainer":
                    return (String)CryptoRegistry.GetRReg("DSConfigDN", Name, ComputerName);
                default:
                    return String.Empty;
            }
        }
        ...
        public X509Certificate2Collection GetCACertificates() {
        ...
        public static AdcsCertificateAuthority[] EnumAdcsServers(String findType, String findValue) {
