...
namespace SysadminsLV.PKI.Management.CertificateServices {
    /// <summary>
    /// The class represents Microsoft Active Directory Certificate Services (<strong>ADCS</strong>) Certification Authority
    /// (<strong>CA</strong>) object and contains related properties and methods.
    /// </summary>
    public class AdcsCertificateAuthority {
        ...
        public AdcsCertificateAuthority(String computerName) {
        ...
        /// </remarks>
        public AdcsCertificateAuthority(String computerName, String name) {
            if (String.IsNullOrEmpty(computerName)) { throw new ArgumentNullException(nameof(computerName)); }
        ...
        /// </summary>
        /// <exception cref="UninitializedObjectException">The <see cref="AdcsCertificateAuthority"/> object is not
        ...
        public AdcsCASecurityDescriptor GetSecurityDescriptor() {
            var sd = new AdcsCASecurityDescriptor(this);
            Byte[] sdBinary;
        ...
        public static AdcsCertificateAuthority Connect(String computerName) {
            if (String.IsNullOrEmpty(computerName)) {throw new ArgumentNullException(nameof(computerName));}
            return new AdcsCertificateAuthority(computerName);
        }
        /// <summary>
        ...
        public static AdcsCertificateAuthority[] GetCA(String findType, String findValue) {
        ...
        /// Wildcard characters: * and ? are accepted.</param>
        /// <returns>Enterprise Certification Authority collection.</returns>
        public static AdcsCertificateAuthority[] EnumEnterpriseCAs(String findType, String findValue) {
            if (!ActiveDirectory.Ping()) { throw new Exception("Non-domain environments are not supported."); }
            List<AdcsCertificateAuthority> CAs = new List<AdcsCertificateAuthority>();
            ...
            while (certConfig.Next() >= 0) {
                ...
                CAs.Add(new AdcsCertificateAuthority(certConfig.GetField("Server"), certConfig.GetField("SanitizedName")));
            }
