...
namespace SysadminsLV.PKI.Management.CertificateServices {
    ...
    public sealed class AdcsCASecurityDescriptor : CommonObjectSecurity {
        readonly String _name;
        readonly String _config;

        internal AdcsCASecurityDescriptor(AdcsCertificateAuthority certificationAuthority) : base(false) {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AdcsCAAccessRule"/> class that represents a new access
        ...
        /// </param>
        /// <returns>
        ///		A new <see cref="AdcsCAAccessRule"/> object that represents a new access control rule
        ...
        public override AccessRule AccessRuleFactory(IdentityReference identityReference, Int32 accessMask, Boolean isInherited,
            ...
            return new AdcsCAAccessRule(identityReference, (AdcsCertificationAuthorityRights)accessMask, type);
        }
        ///  <summary>
        ...
        /// </remarks>
        public Boolean AddAccessRule(AdcsCAAccessRule rule) {
        ...
        /// </summary>
        public override Type AccessRightType => typeof(AdcsCertificationAuthorityRights);
        ...
        /// </summary>
        public override Type AccessRuleType => typeof(AdcsCAAccessRule);

        /// <summary>
        /// This member is not implemented.
        /// </summary>
        public override Type AuditRuleType {
            get { throw new NotSupportedException(Error.E_AUDITNOTSUPPOERTED); }
        }
        /// <summary>
        ...
        public void SetObjectSecurity(Boolean restart) {
            if (CryptoRegistry.Ping(ComputerName)) {
                ...
                if (restart) { AdcsCertificateAuthority.Restart(ComputerName); }
                return;
            }
            if (AdcsCertificateAuthority.Ping(ComputerName)) {
