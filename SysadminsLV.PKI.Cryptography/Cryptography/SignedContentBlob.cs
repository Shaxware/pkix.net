...
namespace SysadminsLV.PKI.Cryptography {
    ...
    public class SignedContentBlob {
        ...
        public void Hash(Oid hashAlgorithm) {
            ...
            Oid transformedOid = OidExtensions.MapHashToSignatureOid(hashAlgorithm);
            using (var hasher = HashAlgorithm.Create(hashAlgorithm.FriendlyName)) {
                if (hasher == null) {
                    throw new CryptographicException("Specified hash algorithm is not valid hashing algorithm.");
                }
