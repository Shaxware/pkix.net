...
namespace SysadminsLV.PKI.Cryptography.X509Certificates {
    ...
    public sealed class X509ApplicationPolicyConstraintsExtension : X509Extension {
        readonly Oid _oid = new Oid(X509ExtensionOidMap.X509ApplicationPolicyConstraints);
        ...
        public X509ApplicationPolicyConstraintsExtension(AsnEncodedData constraints)
            : base(new Oid(X509ExtensionOidMap.X509ApplicationPolicyConstraints), constraints.RawData, true) {
