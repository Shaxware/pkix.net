...
namespace SysadminsLV.PKI.Cryptography.X509Certificates {
    ...
    public sealed class X509CertificatePolicyMappingsExtension : X509Extension {
        readonly Oid _oid = new Oid(X509ExtensionOidMap.X509CertificatePolicyMappings);
        ...
        public X509CertificatePolicyMappingsExtension(AsnEncodedData mappings)
            : base(X509ExtensionOidMap.X509CertificatePolicyMappings, mappings.RawData, true) {
