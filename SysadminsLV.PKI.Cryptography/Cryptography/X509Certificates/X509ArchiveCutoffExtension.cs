...
namespace SysadminsLV.PKI.Cryptography.X509Certificates {
    ...
    public class X509ArchiveCutoffExtension : X509Extension {
        readonly Oid _oid = new Oid(X509ExtensionOidMap.X509ArchiveCutoff, "Archive Cutoff");
        /// <summary>
        ...
        public X509ArchiveCutoffExtension(AsnEncodedData value, Boolean critical)
            : base(new Oid(X509ExtensionOidMap.X509OcspCRLReference, "Archive Cutoff"), value.RawData, critical) {
