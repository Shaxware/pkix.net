...
namespace SysadminsLV.PKI.Cryptography.X509Certificates {
    ...
    public sealed class X509NonceExtension : X509Extension {
        readonly Oid _oid = new Oid(X509ExtensionOidMap.X509OcspNonce, "OCSP Nonce");
        /// <summary>
        ...
        public X509NonceExtension(AsnEncodedData nonceValue, Boolean critical)
            : base(new Oid(X509ExtensionOidMap.X509OcspNonce, "OCSP Nonce") , nonceValue.RawData, critical) {
