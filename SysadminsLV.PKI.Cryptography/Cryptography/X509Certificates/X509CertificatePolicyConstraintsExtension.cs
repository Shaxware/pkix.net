...
namespace SysadminsLV.PKI.Cryptography.X509Certificates {
    ...
    public sealed class X509CertificatePolicyConstraintsExtension : X509Extension {
        readonly Oid _oid = new Oid(X509ExtensionOidMap.X509CertificatePolicyConstraints);
        /// <summary>
        ...
        public X509CertificatePolicyConstraintsExtension(AsnEncodedData constraints)
            : base(X509ExtensionOidMap.X509CertificatePolicyConstraints, constraints.RawData, true){
